...
class GetEnabledMenuItems implements UseCase<List<MenuItem>, NoParams> {
  final MenuItemRepository menuItemRepository;

  const GetEnabledMenuItems(this.menuItemRepository);

  @override
  Future<Either<Failure, List<MenuItem>>> call(NoParams params) async {
    return await menuItemRepository.getEnabledMenuItems();
  }
}

  ...
  void _onUpdateStoreSettings(
    ...
    final result = await _updateStoreSettings(
      UpdateStoreSettingsParams(
        ...
        isCashEnabled: event.isCashEnabled ?? true,
        isCardEnabled: event.isCardEnabled ?? true,
        isTransferEnabled: event.isTransferEnabled ?? false,
        bankName: event.bankName,
        bankAccountNumber: event.bankAccountNumber,
        isQrisEnabled: event.isQrisEnabled ?? false,
        midtransMerchantId: event.midtransMerchantId,
        midtransClientKey: event.midtransClientKey,
        midtransServerKey: event.midtransServerKey,
        isMidtransSandbox: event.isMidtransSandbox ?? true,
        midtransMerchantIdSandbox: event.midtransMerchantIdSandbox,
        midtransClientKeySandbox: event.midtransClientKeySandbox,
        midtransServerKeySandbox: event.midtransServerKeySandbox,
      ),
    );
